...
class TestRateLimitConfig:
    ...
    def test_ai_recommendations_config(self):
        ...
        max_requests, window_seconds, friendly_name = get_rate_limit_config("ai_recommendations")
    ...
    def test_care_plans_generate_config(self):
        ...
        max_requests, window_seconds, friendly_name = get_rate_limit_config("care_plans_generate")
    ...
    def test_default_config(self):
        ...
        max_requests, window_seconds, friendly_name = get_rate_limit_config("unknown_endpoint")
