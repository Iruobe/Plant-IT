...
class TestCreatePlant:
    ...
    def test_create_plant_minimal(self, authenticated_client, sample_plant_minimal):
        ...
        response = authenticated_client.post("/api/v1/plants/", json=sample_plant_minimal)
    ...
    def test_create_plant_empty_name_fails(self, authenticated_client):
        ...
        response = authenticated_client.post("/api/v1/plants/", json={
            "name": "",
            "goal": "decorative"
        })
...
class TestListPlants:
    ...
    def test_list_plants_returns_owned_plants(self, authenticated_client, create_test_plant):
...
class TestUploadUrl:
    ...
    def test_get_upload_url_invalid_extension(self, authenticated_client, create_test_plant):
...
class TestConfirmUpload:
    ...
    def test_confirm_upload_success(self, authenticated_client, create_test_plant, mock_firebase_user):
    ...
    def test_confirm_upload_plant_not_found(self, authenticated_client, mock_firebase_user):
        """Confirming upload for non-existent plant returns 404."""
        fake_id = str(uuid4())
        user_id = mock_firebase_user["uid"]
        key = f"plants/{user_id}/{fake_id}/photo.jpg"
        
        response = authenticated_client.post(f"/api/v1/plants/{fake_id}/confirm-upload?key={key}")
