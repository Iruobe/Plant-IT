...
class TestTodayTasks:
    ...
    def test_today_tasks_returns_active_tasks(
        self, authenticated_client, create_test_care_task
    ):
    ...
    def test_today_tasks_excludes_inactive(
        self, authenticated_client, create_test_care_task
    ):
...
class TestGenerateCarePlan:
    ...
    def test_generate_care_plan_success(
        self, authenticated_client, create_test_plant, mock_bedrock_care_plan
    ):
        """Generating care plan creates tasks for plant."""
        plant = create_test_plant()

        response = authenticated_client.post(
            f"/api/v1/care-plans/generate/{plant['plant_id']}"
        )
    ...
    def test_generate_care_plan_plant_not_found(
        self, authenticated_client, mock_bedrock_care_plan
    ):
...
class TestGetPlantCarePlan:
    ...
    def test_get_plant_care_plan_success(
        self, authenticated_client, create_test_plant, create_test_care_task
    ):
        ...
        response = authenticated_client.get(
            f"/api/v1/care-plans/plant/{plant['plant_id']}"
        )
...
class TestCompleteTask:
    ...
    def test_complete_task_not_found(self, authenticated_client):
        ...
        response = authenticated_client.post(
            "/api/v1/care-plans/complete/task_nonexistent"
        )
