...
class TestScanPlant:
    ...
    @pytest.fixture
    def plant_with_image(self, authenticated_client, create_test_plant, mock_firebase_user):
    ...
    def test_scan_plant_success(self, authenticated_client, plant_with_image):
        ...
        with patch("app.api.v1.ai.analyze_plant_image") as mock_analyze:
            ...
            response = authenticated_client.post("/api/v1/ai/scan", json={
                "plant_id": plant_with_image["plant_id"]
            })
    ...
    def test_scan_plant_no_image(self, authenticated_client, create_test_plant, mock_bedrock):
    ...
    def test_scan_plant_unauthorized(self, client):
        ...
        response = client.post("/api/v1/ai/scan", json={
            "plant_id": str(uuid4())
        })
...
class TestChat:
    ...
    def test_chat_with_plant_context(self, authenticated_client, create_test_plant, mock_chat_service):
    ...
    def test_chat_invalid_session_id_fails(self, authenticated_client, mock_chat_service):
...
class TestRecommendations:
    ...
    def test_recommendations_success(self, authenticated_client, mock_recommendations_service):
        """Getting recommendations returns plant suggestions."""
        response = authenticated_client.post("/api/v1/ai/recommendations", json={
    ...
    def test_recommendations_with_location(self, authenticated_client, mock_recommendations_service):
